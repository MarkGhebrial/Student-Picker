...
public class InterfacePanel extends JPanel {
    ...
    private JTextField filepathBox = new JTextField(rootPath);
    ...
    public InterfacePanel() {
        ...
        //Run this code when the user clicks enter in filepathBox
        filepathBox.addActionListener(actionEvent -> {
            //Reload the files
            LoadFiles(filepathBox.getText());
        });
    ...
    private void LoadFiles (String rootPath) {
        ...
        periodMenu = new JComboBox(periodArray); //Update the list
    }
}
